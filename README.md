...
A cloud data server for Scratch 3. Used by [ArkIDE](https://arkide.site)
...
You can do a similar thing in ArkIDE with the `cloud_host` URL parameter: https://studio.arkide.site/?cloud_host=ws://localhost:9080/
